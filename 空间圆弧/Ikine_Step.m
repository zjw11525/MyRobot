...
for r1 = 1:2%loop1
    if(r1 == 1)
    angle3 = real(asind(s3)); 
    else
    angle3 = 180 - angle3; 
    end
    for r2 = 1:2%loop2
        if(r2 == 1)
        angle2 = asind(C/(sqrt(A^2 + B^2))) - D;
        else
        angle2 = 180 - asind(C/(sqrt(A^2 + B^2))) - D; 
        end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 if n == 1 
        ...
        for i = 1 : n - 1
           ...
           error = abs(Angle(i,1) - Angle_Last(1))/340 + abs(Angle(i,2) - (Angle_Last(2) - 90))/220 +  ...
