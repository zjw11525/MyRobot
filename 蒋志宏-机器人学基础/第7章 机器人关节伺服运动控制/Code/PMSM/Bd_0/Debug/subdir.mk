...
28335_RAM_lnk.out: ../28335_RAM_lnk.cmd $(GEN_CMDS)
	...
	"D:/ccs/ccsv4/tools/compiler/c2000/bin/cl2000" --silicon_version=28 -g --diag_warning=225 --large_memory_model --unified_memory --float_support=fpu32 -z -m"Bd_0.map" --stack_size=0x300 --warn_sections -i"D:/ccs/ccsv4/tools/compiler/c2000/lib" -i"D:/ccs/ccsv4/tools/compiler/c2000/include" --reread_libs --rom_model -o "$@" "$<" "../28335_RAM_lnk.cmd" "../DSP2833x_Headers_nonBIOS.cmd"
...
DSP2833x_ADC_cal.obj: ../DSP2833x_ADC_cal.asm $(GEN_OPTS) $(GEN_SRCS)
	...
	"D:/ccs/ccsv4/tools/compiler/c2000/bin/cl2000" --silicon_version=28 -g --include_path="E:/Mine/biyesheji/number2_test_150531/DSP2833x_common/include" --include_path="E:/Mine/biyesheji/number2_test_150531/DSP2833x_headers/include" --include_path="D:/Program Files (x86)/Texas Instruments/xdais_7_10_00_06/packages/ti/xdais" --include_path="D:/ccs/ccsv4/tools/compiler/c2000/include" --diag_warning=225 --large_memory_model --unified_memory --float_support=fpu32 --preproc_with_compile --preproc_dependency="DSP2833x_ADC_cal.pp" $(GEN_OPTS_QUOTED) $(subst #,$(wildcard $(subst $(SPACE),\$(SPACE),$<)),"#")
	@echo 'Finished building: $<'
	@echo ' '
